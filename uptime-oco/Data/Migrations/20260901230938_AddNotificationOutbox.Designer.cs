...
namespace uptime_oco.Data.Migrations
{
    ...
    [Migration("20260901230938_AddNotificationOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("uptime_oco.NotificationOutbox", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ProcessedAt", "FailedAt", "NextAttemptAt");
            ...
            modelBuilder.Entity("uptime_oco.NotificationOutbox", b =>
                {
                    b.HasOne("uptime_oco.Incident", "Incident")
                        .WithMany()
                        .HasForeignKey("IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("uptime_oco.NotificationChannel", "NotificationChannel")
                        .WithMany()
